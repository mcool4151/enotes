      ...
      if(classname == 'dot-icon' )
      {
        ...
        if(active==0)
        {
          ...
          if(classnamefolder=='trash' || classnamefile == 'trash'){
            ...
            {
              $("#"+folderid).append('<ul class="folder-submenu-container" ><li class="move-to"><i class="ion-android-exit icon" ></i><span class="move-to">Move To..</span></li><li class="download"><i class="ion-archive icon" ></i><span class="download">Download</span></li></ul>');
              if ( $(window).width() > 480)
            ...
            else if(classnamefolder=='favorite' || classnamefile == 'favorite')
            {
              ...
              $("#"+folderid).append('<ul class="folder-submenu-container" ><li class="move-to"><i class="ion-android-exit icon" ></i><span class="move-to">Move To..</span></li><li class="get-shareable-link"><i class="ion-link icon" ></i><span class="get-shareable-link">Get Shareable Link</span></li><li class="favorite"><i class="ion-ios-undo icon" ></i><span class="favorite">Remove From Favorite</span></li><li class="rename"><i class="ion-ios-compose icon" ></i><span class="rename">Rename</span></li><li class="details"><i class="ion-ios-information icon" ></i><span class="details">View Details</span></li><li class="download"><i class="ion-archive icon" ></i><span class="download">Download</span></li><li class="trash"><i class="ion-trash-b icon" ></i><span class="trash">Remove</span></li></ul>');
              if ( $(window).width() > 480)
              $(".file .folder-submenu-container").css({"margin-top":"-180px"});
// regiT was here
prevforid=folderid;
