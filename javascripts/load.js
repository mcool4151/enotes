$(document).ready(function(){
  ...
  function reloadfiles() {
    ...
    $.each(files,function(index,value) {
      ...
      $('#files').html($('#files').html() + "<li class=\"file\" draggable=\"true\" ><div class=\"file-preview\"  style=\"  background-image: url('"+images[index]+"') ;\"></div><div class=\"file-name\" id=\"file"+index+"\"><i class=\"ion-ios-paper folder-icon\" ></i><span>"+value+"</span><i class=\"dot-icon ion-android-more-vertical \" aria-hidden=\"true\"></i></div></li>");
    });
    if(test == 1) {
